...
function renderLogsTable(data) {
  ...
  return `
    <div class="log-table-container">
      <table class="log-table log-table--dense log-table--responsive">
        <thead>
          <tr>
...
function renderLogRow(log) {
  ...
  return `
    <tr>
      <td data-label="${t('admin.auditLogs.timestamp')}" class="log-cell-timestamp">${formatTimestamp(log.timestamp)}</td>
      <td data-label="${t('admin.auditLogs.user')}" class="log-cell-user">
      ...
      <td data-label="${t('admin.auditLogs.action')}" class="log-cell-action">${escapeHtml(log.action)}</td>
      <td data-label="${t('admin.auditLogs.context')}" class="log-cell-context hide-mobile">${escapeHtml(log.context)}</td>
      <td data-label="${t('admin.auditLogs.message')}" class="log-cell-message">${escapeHtml(log.message)}</td>
    </tr>
  `;
}
